...
public class Application {
    ...
    private static void chooseSubMenu() {
       ...
       do {
           ...
           switch (no){
               case 1 : menuService.searchMenuBySubCategory(inpuSubCategory()); break;
               case 9 : return;
           }
       }while (true);
    ...
    private static SearchCriteria inpuSubCategory(){
        Scanner sc = new Scanner(System.in);
    ...
    private static SearchCriteria inputAllOrOne() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.println("검색 조건을 입력 하시겠습니까? (yse, no) :");
        boolean hasSearchValue = "yes".equals(sc.nextLine())? true:false;
    ...
    private static Map<String,Object> inputSearchCriteriaMap() {
        ...
        if("category".equals(condition)){
            ...
            System.out.println("검색할 이름을 이름을 입력 해주세요");
            String nameValue = sc.nextLine();
            System.out.println("검색할 카테고리 코드를 입력 해주세요");
            int categoryValue = sc.nextInt();
